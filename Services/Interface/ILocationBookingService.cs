...
namespace FilmMaker.Services.Interface
{
    public interface ILocationBookingService
    {
        ...
        Task<ApiResponse<List<LocationBookingCalendarDayDto>>> GetLocationBookingCalendarAsync(int currentUserId, int locationId, DateTime? fromDate, DateTime? toDate);
